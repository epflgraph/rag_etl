...
class CS200Course(BaseCourse):
    ...
    tag_metadata = {
        ...
        "EXERCISE_BOOK_SOLUTION": {
            "type": "practice",
            "subtype": "exercise_book_solution",
            "one_chunk_per_page": False,
        ...
        "EXERCISE_ARCH": {
            "type": "practice",
            "subtype": "exercise_architecture",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
            "pdf_to_markdown": True,
            "split_exercises": True,
        },
        "EXERCISE_ARCH_SOLUTION": {
            "type": "practice",
            "subtype": "exercise_architecture",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
        ...
        "EXERCISE_PROC": {
            "type": "practice",
            "subtype": "exercise_processor",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
            "pdf_to_markdown": True,
            "split_exercises": True,
        },
        "EXERCISE_PROC_SOLUTION": {
            "type": "practice",
            "subtype": "exercise_processor",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
        ...
        "EXERCISE_MEMORY": {
            "type": "practice",
            "subtype": "exercise_memory",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
            "pdf_to_markdown": True,
            "split_exercises": True,
        },
        "EXERCISE_MEMORY_SOLUTION": {
            "type": "practice",
            "subtype": "exercise_memory",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
        ...
        "EXERCISE_PARALLELISM": {
            "type": "practice",
            "subtype": "exercise_parallelism",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
            "pdf_to_markdown": True,
            "split_exercises": True,
        },
        "EXERCISE_PARALLELISM_SOLUTION": {
            "type": "practice",
            "subtype": "exercise_parallelism",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
        ...
        "EXERCISE_MULTIPROC": {
            "type": "practice",
            "subtype": "exercise_multiprocessor",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
            "pdf_to_markdown": True,
            "split_exercises": True,
        },
        "EXERCISE_MULTIPROC_SOLUTION": {
            "type": "practice",
            "subtype": "exercise_multiprocessor",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
