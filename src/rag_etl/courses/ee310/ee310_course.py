...
class EE310Course(BaseCourse):
    """
    Course-specific pipeline for EE310.
    """

    course_info = {
        "course_title": "Systèmes embarqués microprogrammés",
        "course_id": "EE310",
        "academic_course": "2026-2027",
        "semester": 1,
        "admin_info_link": "https://moodle.epfl.ch/course/view.php?id=7851",
        "coursebook_link": "https://edu.epfl.ch/coursebook/en/microprogrammed-embedded-systems-EE-310",
        "course_language": "fr",
    }
    ...
    tag_metadata = {
        ...
        "PRACTICAL_WORK": {
            "type": "practice",
            "subtype": "practical_work",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
            "pdf_to_markdown": True,
            "split_exercises": False,
        },
        "PRACTICAL_WORK_SOLUTION": {
            "type": "practice",
            "subtype": "practical_work",
            "one_chunk_per_page": False,
            "one_chunk_per_doc": True,
