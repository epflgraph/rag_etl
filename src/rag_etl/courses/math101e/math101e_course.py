...
class MATH101eCourse(BaseCourse):
    """
    Course-specific pipeline for MATH101e.
    """

    course_info = {
        "course_title": "Analyse I",
        "course_id": "MATH101e",
        "academic_course": "2026-2027",
        "semester": 1,
        "admin_info_link": "https://moodle.epfl.ch/course/view.php?id=14840",
        "coursebook_link": "https://edu.epfl.ch/coursebook/en/analysis-i-MATH-101-E",
        "course_language": "fr",
    }
    ...
    mediaspace_playlist_or_channel_url = (
        "https://mediaspace.epfl.ch/channel/MATH-101%2528e%2529%2BAnalyse%2BI%2BIN_SC/49293"
    )
...
if __name__ == "__main__":
    ...
    course = BaseCourse.from_code("MATH101e")
    course.run()
