...
class MATH115aCourse(BaseCourse):
    """
    Course-specific pipeline for MATH115a.
    """

    course_info = {
        "course_title": "Algèbre linéaire avancée II - diagonalisation",
        "course_id": "MATH115a",
        "academic_course": "2025-2026",
        "semester": 2,
        "admin_info_link": "https://moodle.epfl.ch/course/view.php?id=14157",
        "coursebook_link": "https://edu.epfl.ch/coursebook/fr/algebre-lineaire-avancee-ii-diagonalisation-MATH-115-A"
    }
...
if __name__ == '__main__':
    ...
    course = BaseCourse.from_code('MATH115a')
    course.run()
