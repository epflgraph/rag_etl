...
class MATH535Course(BaseCourse):
    """
    Course-specific pipeline for MATH535.
    """

    course_info = {
        "course_title": "Algebraic geometry III - selected topics",
        "course_id": "MATH535",
        "academic_course": "2025-2026",
        "semester": 2,
        "admin_info_link": "https://moodle.epfl.ch/course/view.php?id=16449",
        "coursebook_link": "https://edu.epfl.ch/coursebook/en/algebraic-geometry-iii-selected-topics-MATH-535"
    }
...
if __name__ == '__main__':
    ...
    course = BaseCourse.from_code('MATH535')
    course.run()
