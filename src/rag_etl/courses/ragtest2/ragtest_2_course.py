...
from rag_etl.courses.ragtest2.ragtest_2_metadata_transformer import RAGTEST2MetadataTransformer


class RAGTEST2Course(BaseCourse):
    """
    Course-specific pipeline for RAGTEST 2.
    """

    def __init__(self):
        self.metadata_transformer = RAGTEST2MetadataTransformer(cache=self.course_code)
...
if __name__ == '__main__':
    ...
    course = BaseCourse.from_code('RAGTEST2')
    course.run()
