...
class UNIL134Course(BaseCourse):
    """
    Course-specific pipeline for UNIL134.
    """

    course_info = {
        "course_title": "Chimie organique",
        "course_id": "UNIL134",
        "academic_course": "2025-2026",
        "semester": 2,
        "admin_info_link": "https://moodle.epfl.ch/course/view.php?id=18415",
        "coursebook_link": "",
    }
...
if __name__ == "__main__":
    ...
    course = BaseCourse.from_code("UNIL134")
    course.run()
